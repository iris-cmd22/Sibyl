...
# Come realizzato: definisce gli argomenti (repo, --model, --report, --max-steps, --resume),
#            risolve la sorgente, calcola il percorso del report, avvisa se c'è un checkpoint,
#            e lancia run_agent con asyncio.run.
def main() -> None:
    ...
    report_path = args.report or default_report_path(args.repo_path, args.model)
